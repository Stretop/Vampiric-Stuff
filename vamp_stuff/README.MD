...
This is the mod I've made a long time ago when I was a mobile CDDA player. It provides a mild RPG feeling to the players by partaking a bunch of questlines for simple rewards.

- This mod will only work with the latest experimental of CDDA. Update your client before using this.
- Never forget to turn on static NPC before finalizing your world creation, or you won't encounter any NPCs with this mod.
...
* **Profane Conjurer** - Caster that casts cheap spells and focuses more in reserving mana. Most of its spell inflicts status ailments that also deals damage. Unique prowess of a profane conjurer is the ability to control spectacular bursts of unholy elements. It's like kelvinist, but edgy.
